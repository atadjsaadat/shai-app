...
function formatWinDateShort(iso: string): string {
                  ...
                  >
                    {win.photo_url ? (
                      ...
                      <div className={styles.cardText}>
                        ...
                        <span className={styles.tileDate} style={{ color: c.text, opacity: 0.65 }}>{formatWinDateShort(win.logged_at)}</span>
                      </div>
                    )}
                  </div>
                );
              ...
              <div className={styles.detailBody}>
                ...
                <div className={styles.detailMeta}>
                  <div className={styles.detailMetaRow}>
                    ...
                    <span>{formatWinDate(w.logged_at)}</span>
                  </div>
