...
const I = (children: JSX.Element | JSX.Element[], size = 13) => (
...
const MILESTONE_TYPE_PATHS: Record<string, JSX.Element> = {
  // Social & Emotional
...
export default function BabyBookPage() {
  ...
  const currentAgeMonths = childDob
    ? Math.floor((Date.now() - new Date(childDob).getTime()) / (1000 * 60 * 60 * 24 * 30.44))
    : null
